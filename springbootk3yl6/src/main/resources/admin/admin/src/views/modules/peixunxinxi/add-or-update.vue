<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训名称" prop="peixunmingcheng">
          <el-input v-model="ruleForm.peixunmingcheng" 
              placeholder="培训名称" clearable  :readonly="ro.peixunmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训名称" prop="peixunmingcheng">
              <el-input v-model="ruleForm.peixunmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训周期" prop="peixunzhouqi">
          <el-input v-model="ruleForm.peixunzhouqi" 
              placeholder="培训周期" clearable  :readonly="ro.peixunzhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训周期" prop="peixunzhouqi">
              <el-input v-model="ruleForm.peixunzhouqi" 
                placeholder="培训周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训费用" prop="peixunfeiyong">
          <el-input v-model="ruleForm.peixunfeiyong" 
              placeholder="培训费用" clearable  :readonly="ro.peixunfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训费用" prop="peixunfeiyong">
              <el-input v-model="ruleForm.peixunfeiyong" 
                placeholder="培训费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='peixunzhouqi'){
            this.ruleForm.peixunzhouqi = obj[o];
	    this.ro.peixunzhouqi = true;
            continue;
          }
          if(o=='peixunfeiyong'){
            this.ruleForm.peixunfeiyong = obj[o];
	    this.ro.peixunfeiyong = true;
            continue;
          }
          if(o=='peixundidian'){
